...
export default function BatchPage() {
  ...
  useEffect(() => {
    fetch("/api/profile/me")
      ...
      .then((data) => data && setMyProfile(data.profile))
      .catch(() => {});
  }, []);
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", ...pageBackground }}>
      ...
      <div style={styles.container}>
        ...
        {/* Signing as — signature is automatic based on login */}
        {myProfile && (
          <p style={{ fontSize: "12px", color: "#9aa0a6", marginBottom: "14px" }}>
            Sending as <strong style={{ color: "#e8eaed" }}>{myProfile.display_name || myProfile.email}</strong> —{" "}
            <a href="/account" style={{ color: "#34d399" }}>edit your signature</a>
          </p>
        )}
...
const styles = {
  ...
  checkbox: { marginTop: "5px", width: "20px", height: "20px", cursor: "pointer" },
  rowContent: { flex: 1, display: "flex", flexDirection: "column", gap: "7px" },
  rowTop: { display: "flex", justifyContent: "space-between", alignItems: "center" },
  rowFrom: { fontSize: "17px", fontWeight: "600", color: "#1a1a2e" },
  guessBadge: {
    fontSize: "12px",
    fontWeight: "600",
    padding: "4px 12px",
  ...
  rowSubject: { fontSize: "15px", fontWeight: "600", color: "#334155" },
  rowPreview: { fontSize: "14px", color: "#94a3b8", lineHeight: "1.55" },
