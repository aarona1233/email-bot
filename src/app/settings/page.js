...
// ─────────────────────────────────────────────────────────
// Every knob for the follow-up system lives here:
//   - master on/off
//   - how many days of silence before a nudge
//   - how often the scanner checks (in hours)
//   - auto-send vs. human-approval queue
//   - max nudges per customer
//   - a pause-until date, for exactly the "everyone's on
//     vacation / it's Christmas" scenario
// ─────────────────────────────────────────────────────────
    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <main style={{ ...styles.page, flex: 1, minWidth: 0 }}>
        <div style={styles.container}>
          ...
          {/* AI signature — for fully autonomous sends only */}
          <div style={styles.card}>
            <p style={styles.cardTitle}>AI Signature</p>
            <p style={styles.cardSub}>
              Used ONLY when the AI sends something with no human involved (auto-send
              follow-ups). Never used on anything a person reviewed or edited — those
              always get that person's own signature from their Account page.
            </p>
            <textarea
              value={settings.ai_signature || ""}
              onChange={(e) => update("ai_signature", e.target.value)}
              style={styles.aiSignatureTextarea}
              rows={3}
              placeholder="Coalition Space Team"
            />
          </div>
          ...
          <div style={styles.card}>
            ...
            <p style={styles.cardSub}>
              ...
              customers who are busy sitting on Santa's lap. While this date is in the future,
              no follow-ups are created or sent — everything else keeps running.
            </p>
            <div style={styles.numberRow}>
              <input
                type="date"
